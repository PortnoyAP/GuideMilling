        ...
        uncOrMetricSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                switch (selectedItem){
                    ...
                    case "UNC": initSpinnerTap(tapUnc_Names, hashMapPreDrillDiameterUncCutting, hashMapPreDrillDiameterUncForming,hashMapTapUncDiameter);
                    break;

                    case "UNC H.C": initSpinnerTap(tapUnc_HC_Names, hashMapPreDrillDiameterUnc_HC, hashMapPreDrillDiameterUnc_HC,hashMapTapUnc_HC_Diameter);
                    break;

                    case "Metric": initSpinnerTap(tapMetricNames, hashMapPreDrillDiametersMetricCutting, hashMapPreDrillDiameterMetricForming,hashMapTapMetricDiameter);
                    break;

                    case "Metric H.C":initSpinnerTap(tapMetric_HC_Names, hashMapPreDrillDiametersMetric_HC, hashMapPreDrillDiametersMetric_HC,hashMapTapMetric_HC_Diameter);
                    break;
